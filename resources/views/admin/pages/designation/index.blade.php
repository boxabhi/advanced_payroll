                        ...
                        <div id="data_table_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    ...
                                    <a href="{{route('department.create')}}" class="btn btn-info">Create Designation</a>
                                            </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <table id="data_table" class="table table-bordered table-striped dataTable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                <td>{{ $loop->index + 1 }}</td>
                                            <td class="sorting_1">{{$department->department}}</td>
                                                <td class="text-center">

                                                <a class="btn btn-danger" href="{{ route('department.destroy' , $department->id)}}">
                                                    <i class="ti-trash"></i> Delete Designation
                                                </a>


                                                <a class="btn btn-success" href="{{ route('department.destroy' , $department->id)}}">
                                                    <i class="ti-bookmark-alt"></i> Edit Designation
                                                </a>
